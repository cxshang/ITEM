...
cdef extern from "<sparsehash/sparse_hash_set>" namespace "google":
    cdef cppclass sparse_hash_set[T]:
        cppclass iterator:
            T& operator*()
        ...
        size_t size() nogil
        void swap(sparse_hash_set&) nogil
